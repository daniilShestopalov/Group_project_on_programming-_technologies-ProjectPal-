...
class GroupBlockOpenCreateWidget extends StatefulWidget {
  final int userId;
  final int groupId;

  GroupBlockOpenCreateWidget({
    required this.userId,
    required this.groupId,
  });

  @override
  _GroupBlockOpenCreateWidgetState createState() => _GroupBlockOpenCreateWidgetState();
}

class _GroupBlockOpenCreateWidgetState extends State<GroupBlockOpenCreateWidget> {
                    ...
                    onPressed: () async {
                      ...
                      if (token != null) {
                        try {
                          ...
                          int? groupId = await apiService.createGroup(
                            token: token,
                          ...
                          if (groupId != null) {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text('Группа создана и студенты обновлены'),
                              ),
                            );
                          }
                        } catch (e) {
